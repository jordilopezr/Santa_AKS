...
module "aks" {
  ...
  source = "../modules" # IMPORTANTE: Debes usar la ruta correcta del módulo
  ...
  #function_acronym = var.function_acronym
  #sequence_number  = var.sequence_number
  #object_id        = var.object_id
  inherit          = var.inherit
  analytics_diagnostic_monitor_name = var.analytics_diagnostic_monitor_name
  analytics_diagnostic_monitor_lwk_id = var.analytics_diagnostic_monitor_lwk_id
  private_dns_zone_rsg_name = var.private_dns_zone_rsg_name
